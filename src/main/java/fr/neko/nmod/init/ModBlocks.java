...
public class ModBlocks {
    ...
    public static final RegistryObject<Block> SAKURA_LOG = createBlock("sakura_log",()  -> new Block(AbstractBlock.Properties.of(Material.WOOD).strength(3f, 15f).harvestTool(ToolType.AXE).harvestLevel(0)));
