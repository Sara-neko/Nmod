...
// Items
    public static final RegistryObject<Item> LIQUID_PHAZON = ITEMS.register("liquid_phazon", () -> new Item(new Item.Properties().stacksTo(4).tab(ModItemGroups.Nmod_TAB)));
    public static final RegistryObject<Item> TEA_LEAF = ITEMS.register("tea_leaf", () -> new Item(new Item.Properties().tab(ModItemGroups.Nmod_TAB)));
    public static final RegistryObject<Item> DRIED_TEA_LEAF = ITEMS.register("dried_tea_leaf", () -> new Item(new Item.Properties().tab(ModItemGroups.Nmod_TAB)));
    public static final RegistryObject<Item> CUP = ITEMS.register("cup", () -> new Item(new Item.Properties().stacksTo(4).tab(ModItemGroups.Nmod_TAB)));
    public static final RegistryObject<Item> GROUND_COFFEE = ITEMS.register("ground_coffee", () -> new Item(new Item.Properties().tab(ModItemGroups.Nmod_TAB)));
    public static final RegistryObject<Item> FLOUR = ITEMS.register("flour", () -> new Item(new Item.Properties().tab(ModItemGroups.Nmod_TAB)));
    public static final RegistryObject<Item> EDARITE_CRYSTAL = ITEMS.register("edarite_crystal", () -> new Item(new Item.Properties().tab(ModItemGroups.Nmod_TAB)));
    public static final RegistryObject<Item> STEEL_INGOT = ITEMS.register("steel_ingot", () -> new Item(new Item.Properties().tab(ModItemGroups.Nmod_TAB)));
    public static final RegistryObject<Item> BISMUTH_CRYSTAL = ITEMS.register("bismuth_crystal",()-> new Item(new Item.Properties().tab(ModItemGroups.Nmod_TAB)));
    public static final RegistryObject<Item> DARK_INGOT = ITEMS.register("dark_ingot", ()-> new Item(new Item.Properties().tab(ModItemGroups.Nmod_TAB)));
    public static final RegistryObject<Item> LAVA_ROCK = ITEMS.register("lava_rock",() -> new Item(new Item.Properties().tab(ModItemGroups.Nmod_TAB)));

//Arme et Outil
    public static final RegistryObject<Item> PHAZON_SWORD = ITEMS.register("phazon_sword", () -> new SwordItem(CustomItemTiers.PHAZON,4, -2.1f, new Item.Properties().stacksTo(1).tab(ModItemGroups.Nmod_TAB)));
